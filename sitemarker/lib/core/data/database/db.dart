...
import 'package:sitemarker/core/data/database/databases/shared.dart' as impl;
...
class SitemarkerDB extends _$SitemarkerDB {
  ...
  Future<List<SitemarkerRecord>> getRecordsById(int id) {
    return (select(sitemarkerRecords)..where((t) => t.id.equals(id))).get();
  }
