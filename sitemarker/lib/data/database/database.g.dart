...
abstract class _$SitemarkerDB extends GeneratedDatabase {
  ...
  _$SitemarkerDBManager get managers => _$SitemarkerDBManager(this);
...
typedef $$SitemarkerRecordsTableInsertCompanionBuilder
...
class $$SitemarkerRecordsTableTableManager extends RootTableManager<
    ...
    $$SitemarkerRecordsTableProcessedTableManager,
    $$SitemarkerRecordsTableInsertCompanionBuilder,
  ...
  $$SitemarkerRecordsTableTableManager(
      ...
      : super(TableManagerState(
          ...
          table: table,
          filteringComposer:
              $$SitemarkerRecordsTableFilterComposer(ComposerState(db, table)),
          orderingComposer: $$SitemarkerRecordsTableOrderingComposer(
              ComposerState(db, table)),
          getChildManagerBuilder: (p) =>
              $$SitemarkerRecordsTableProcessedTableManager(p),
...
class $$SitemarkerRecordsTableProcessedTableManager
    extends ProcessedTableManager<
        ...
        $$SitemarkerRecordsTableInsertCompanionBuilder,
        $$SitemarkerRecordsTableUpdateCompanionBuilder> {
  $$SitemarkerRecordsTableProcessedTableManager(super.$state);
}

class $$SitemarkerRecordsTableFilterComposer
    extends FilterComposer<_$SitemarkerDB, $SitemarkerRecordsTable> {
  $$SitemarkerRecordsTableFilterComposer(super.$state);
...
class $$SitemarkerRecordsTableOrderingComposer
    extends OrderingComposer<_$SitemarkerDB, $SitemarkerRecordsTable> {
  $$SitemarkerRecordsTableOrderingComposer(super.$state);
...
class _$SitemarkerDBManager {
  final _$SitemarkerDB _db;
  _$SitemarkerDBManager(this._db);
